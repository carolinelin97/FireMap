require([
    ...
    function getData(callbackIN) {
        var ref = firebase.database().ref(today); //change to today
    ...
    function genFunction(data) {
        ...
        Object.entries(data).forEach(([inst,valu]) => {
            features.push({
                ...
                attributes:{ObjectID:i,IncidentID:inst, IncidentName:valu.IncidentName,
                    City:valu.City,County:valu.County,State:valu.State,
                    DiscoveryAcres:valu.DiscoveryAcres,DailyAcres:valu.DailyAcres||"Unknown",FireCause:valu.FireCause||"Unknown",
                    FireDiscoveryDateTime:valu.FireDiscoveryDateTime||"Unknown",InitialResponseAcres:valu.InitialResponseAcres||"Unknown",
                    PercentContained:valu.PercentContained||"Unknown",ContainmentDateTime:valu.ContainmentDateTime||"Unknown",
